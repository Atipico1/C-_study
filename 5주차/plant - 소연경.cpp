...
void Plant::select(int n){
    if (n==1){
        ...
        cout << "You entered the wrong number. Select the number randomly.\n";
        if (rand()%10>6){
            cout << "Selected strawberry automatically.\n";
            base_hp = 10;
        }
        else if (rand()%10>3){
            cout << "Selected cherry tomato automatically.\n";
            base_hp = 15;
        }
        else{
            cout << "Selected basil automatically.\n";
            base_hp = 30;
        }
    }
    cur_hp = 10;
...
int main(){
    ...
    for (int i;i<100;i++){
        ...
        if (b_num==0){
            ...
            cout << "You entered the wrong number. Select the number randomly.\n";
            if (rand()%10>6){
                cout << "Selected water automatically.\n";
                p.water();
            }
            else if (rand()%10>3){
                cout << "Selected watch automatically.\n";
                p.watch();
            }
            else{
                cout << "Selected kill insects automatically.\n";
                p.kill();
            }
        }
